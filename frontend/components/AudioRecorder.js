...
export default function AudioRecorder({ sentRequests, completedRequests }) {
      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.recordButtonContainer}>
          <TouchableOpacity
            ...
            disabled={isUploading || !selectedRequest}
          >
            <Ionicons
              name="mic"
              size={40}
              color={isRecording ? "#ff4444" : (!selectedRequest ? "#ccc" : "#4A90E2")}
            />
          </TouchableOpacity>
